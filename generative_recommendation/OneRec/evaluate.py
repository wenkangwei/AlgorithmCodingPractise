...
def main(
    ...
    category_dict = {"Arts": "arts", "Industrial_and_Scientific": "industrial and scientific items", "Office_Products": "office products", "Toys_and_Games": "toys and games", "Sports": "sports and outdoors", "Books": "books"}
    ...
    val_dataset = EvalSidDataset(train_file=test_data_path, tokenizer=tokenizer, max_len=2560, sample=sample ,category=category, test=True, K=K, seed=seed)
